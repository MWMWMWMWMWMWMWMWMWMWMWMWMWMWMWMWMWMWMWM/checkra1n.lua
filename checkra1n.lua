...
local tex2make = {"==================","","checkbl0x 0.9.5", "", "Proudly written in vscode", "(c) 69-420 spec", "", "This software is not for sale", "If you have purchased this, please", "report the seller.", "", "Get it for free at twitch.tv/logout", "", "=== Made by ===", "allah", "=== Thanks to ===", "skid", "Cellebrite (uhh)", "==================", "Enabling HAX ... done!", "UHH: Found nothing"}
